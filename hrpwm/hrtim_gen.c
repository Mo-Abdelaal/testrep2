...
void MX_HRTIM1_Init(void)
{
  ...
  pCompareCfg.CompareValue = 0x4081;
  ...
  pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMCMP2|HRTIM_OUTPUTRESET_EEV_1;
  ...
  pOutputCfg.ResetSource = HRTIM_OUTPUTRESET_TIMPER|HRTIM_OUTPUTRESET_EEV_2;
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspPostInit 0 */
    ...
    PA11     ------> HRTIM1_CHB2
    */
    GPIO_InitStruct.Pin = uC_PFC_PWM_A_Pin|uC_PFC_PWM_B_Pin|uC_Rect_PWM_A_Pin|uC_Rect_PWM_B_Pin;
